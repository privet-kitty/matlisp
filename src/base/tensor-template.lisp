...
(deft/method t/store-allocator (sym index-store) (size &optional initial-contents)
  `(the index-store (make-array ,size :element-type 'index-type ,@(when initial-contents `(:initial-contents ,initial-contents)))))
