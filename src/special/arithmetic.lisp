...
(define-tensor-method tb^ ((a dense-tensor :x) (b dense-tensor :x))
  `(cart-etypecase (a b)
	...
	(iter (for-mod idx from 0 below (dimensions b) with-iterator ((:stride ((of-b (strides b) (head b))
	      ...
	      (axpy! (t/store-ref ,(cl :x) sto-b of-b) a ret-a))
	ret))))
...
(define-tensor-method ge== (a (b dense-tensor :x))
  `(let ((a (t/coerce ,(field-type (cl :x)) a))
     ...
     (dorefs (idx (dimensions b))
	     ...
	     (when (t/f= ,(field-type (cl :x)) a ref.b) (setf ref.r 1)))
     ret))
  ...
  `(let ((ret (zeros (dimensions a) '(bit))))
     (dorefs (idx (dimensions a))
	     ((ref.a a :type ,(cl :x))
	      (ref.b b :type ,(cl :x))
	      (ref.r ret :type ,(tensor 'bit)))
	     (when (t/f= ,(field-type (cl :x)) ref.a ref.b) (setf ref.r 1)))
     ret))
